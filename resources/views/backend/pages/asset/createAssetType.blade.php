    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-header">
                <h3 class="block-title">Add Asset Type</h3>
            </div>

            <form class="js-validation form-prevent-multiple-submission" action="{{ url('assetsType/store') }}" id="form" method="POST" onsubmit="return validate_inputs(event)">
                @csrf
                <div class="block block-rounded">
        ...
        function validate_inputs(e) {
            ...
            if ( name) {
                $.ajax({
                    type: 'POST',
                    async:false,
                    url: '{{ url('assetsType/validate_inputs') }}',
                    data: $('#form').serialize(),
