...
@section('page_action')
    <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-alt">
            ...
            <li class="breadcrumb-item"><a class="link-fx" href="{{ url('assetsType/') }}">Asset Type</a></li>
    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-header">
                <h3 class="block-title">Edit Asset Type</h3>
            </div>
            <form class="js-validation" id='form' action='{{ url('assetsType/' . $asset_type->id . '/update_asset_type')}}' method="POST" onsubmit="return validate_name(event)">
                @csrf
                <div class="block block-rounded">
    ...
    <script>
        function validate_name(e) {
            $.ajax({
                type: 'POST',
                async:false,
                url: '{{ url('assetsType/'. $asset_type->id .'/validate_name') }}',
                data: $('#form').serialize(),
