    ...
    <div class="mt-3 mt-sm-0 ml-sm-3">
        <a href="{{ url('asset/add') }}">
            <button type="button" class="btn btn-dark mr-1 mb-3">
                <i class="fa fa-fw fa-key mr-1"></i> Add Asset
            </button>
        </a>
    </div>
@endsection
    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-header">
                <h3 class="block-title">Manage Assets</h3>
            </div>
            <div class="block-content block-content-full">
                <!-- DataTables init on table by adding .js-dataTable-buttons class, functionality is initialized in js/pages/be_tables_datatables.min.js which was auto compiled from _js/pages/be_tables_datatables.js -->
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons " id="asset_table">
                        <thead>
                        <tr>
                        ...
                        <div class="modal-content">
                            <form id="delete" action="" method="post">
                                ...
                                <div class="block block-rounded block-themed block-transparent mb-0">
                                    ...
                                    <div class="block-content font-size-sm">
                                        <p class="text-center"><span id="asset_name"></span> Asset will be deleted. Are you sure?</p>
                        ...
                        <div class="modal-content">
                            <form id="restore" action="" method="post">
                                ...
                                <div class="block block-rounded block-themed block-transparent mb-0">
                                    ...
                                    <div class="block-content font-size-sm">
                                        <p class="text-center"><span id="restore_asset_name"></span> Asset will be restored. Are you sure?</p>
                                        <input type="hidden" name="restore_asset_id" id="restore_asset_id">
                                    </div>
                                    <div class="block-content block-content-full text-right border-top">
                                        <button type="button" class="btn btn-alt-primary mr-1" data-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-primary">Submit</button>
...
@section('js_after')
    ...
    <script type="text/javascript">
        jQuery(document).ready(function ($) {
            ...
            var dtable = $('#asset_table').DataTable({
                responsive: true,
                ajax: '{{ url('asset/get_asset_data') }}',
                paging: true,
        ...
        function show_status_modal(id, msg) {
            ...
            const url = "{{ url('asset/:id/change_status') }}".replace(':id', id);
            $('#change_status').attr('action', url);
            $('#status-modal').modal('show');
        }
        function show_delete_modal(id, name) {
            var x = document.getElementById('asset_name');
            x.innerHTML = name;
            const url = "{{ url('asset/:id/delete') }}".replace(':id', id);
            $('#delete').attr('action', url);
            $('#delete-modal').modal('show');
        }
        function show_restore_modal(id, name) {
            var x = document.getElementById('restore_asset_name');
            x.innerHTML = name;
