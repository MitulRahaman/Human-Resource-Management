...
@section('content')
    ...
    @include('backend.layouts.error_msg')
        <div class="block block-rounded">
            ...
            <form class="js-validation form-prevent-multiple-submission" action="{{ url('bank/store') }}" id="form" method="POST" onsubmit="return validate_inputs(event)">
                @csrf
                <div class="block block-rounded">
                        ...
                        <div class="row items-push ml-10">
                            <div class="col-lg-6 col-xl-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control input-prevent-multiple-submission" id="address" name="address" rows="5" placeholder="Bank Address">{{ old('address') }}</textarea>
                                </div>
                            </div>
                        </div>
                        <!-- END Regular -->
