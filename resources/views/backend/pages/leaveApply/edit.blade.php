                        ...
                        <div class="row items-push">
                            <div class="col-lg-12 col-xl-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="js-flatpickr form-control bg-white" id="date-range" name="date-range" data-mode="range" data-date-format="d-m-Y" data-min-date="today" value = "{{ $leave->start_date }} to {{$leave->end_date}}" required>
                                </div>
                                <div class="form-group">
